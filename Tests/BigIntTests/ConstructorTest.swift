...
class ConstructorTest: XCTestCase {
    ...
    func test1() {
        ...
        XCTAssertEqual(x1.limbs.count, 1)
        XCTAssertFalse((x1.isNegative))
        let x2 = BInt("-0", radix: 10)!
        XCTAssertEqual(x2.limbs.count, 1)
    ...
    func test2() {
        ...
        let x1 = BInt(1)
        let xm1 = BInt(-1)
        XCTAssertEqual(x0.limbs.count, 1)
        XCTAssertEqual(x1.limbs.count, 1)
        XCTAssertEqual(xm1.limbs.count, 1)
